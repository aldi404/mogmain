                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="#service-portfolio" class="dropdown-item">Service Portfolio</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{ route('user::events::index_events') }}" class="dropdown-item">Events Gallery</a>
                        </div>
                    </li>
                    {{-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="https://api.whatsapp.com/send?phone=6282316382299" class="nav-link contact-btn" target="_blank">Contact</a>
                    </li>
                </ul>
            </nav>
    ...
    <div id="mobileNav" class="mobile-nav">
        ...
        <div class="mobile-nav-content">
            ...
            <nav class="mobile-nav-menu">
                ...
                <a href="https://api.whatsapp.com/send?phone=6282316382299" class="mobile-nav-link contact-link" target="_blank" rel="noopener noreferrer">Contact</a>
            </nav>
        </div>
    </div>
</header>
