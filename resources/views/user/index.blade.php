            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200">Mogmain specializes in organizing diverse events and
                            festivals,
                    ...
                    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="300">
                        <form action="forms/newsletter.php" method="post" class="php-email-form">
                            <div class="sign-up-form"><input type="email" name="email"
                                    placeholder="Type your email"><input type="submit" value="Subscribe"></div>
                ...
                <div class="row justify-content-center g-4">
                    <div class="col-lg-6 col-md-12 mb-4 d-flex justify-content-center">
                        <div class="ratio ratio-16x9 w-100" style="max-width: 600px;">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/169TRgWK5ro"
                                title="Recap Jatim Warrior 3x3 Basketball Competition 2024 - Bank Jatim" frameborder="0"
                    ...
                    <div class="col-lg-6 col-md-12 mb-4 d-flex justify-content-center">
                        <div class="ratio ratio-16x9 w-100" style="max-width: 600px;">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/SNMbnqVa-vE"
                                title="Final Jatim Warrior 3x3 Basketball Competition" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <div class="about-item text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h3>Introduction:</h3>
                            <p>EBMA is a dynamic and creative event planning company, committed to delivering unique and
                                impactful events</p>
                        </div>
                        ...
                        <div class="about-item text-center" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <h3>Services:</h3>
                            <p>We offer a wide array of event services, from concept development to full event
                                management (all in one). Corporate events, Festivals, Sports, Exhibitions, Gatherings.
                                We also rent event equipments & production.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="services-diagram" data-aos="fade-up" data-aos-delay="100">
                            <img src="{{ asset('assets_user/img/services_main.png') }}" alt="EBMA Services Diagram"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="benefits-grid">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-6" data-aos="fade-up" data-aos-delay="300">
                                <div class="benefit-item">
                                    <div class="benefit-icon">
                                        <img src="{{ asset('assets_user/img/services_4.png') }}"
                                            alt="Expertise and Creativity">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-6" data-aos="fade-up" data-aos-delay="400">
                                <div class="benefit-item">
                                    <div class="benefit-icon">
                                        <img src="{{ asset('assets_user/img/services_5.png') }}"
                                            alt="Reduced Stress">
                                    </div>
                                ...
                                <div class="col-6 col-md-4 col-lg-4 mb-4">
                                    <div data-aos="fade-up" data-aos-delay="{{ 100 + $index * 100 }}">
                                        <div class="service-item"
                                            onclick="window.location.href='{{ route('user::events::index_events') }}'">
                        ...
                        <div class="row">
                            @foreach ($servicePortfolios as $index => $portfolio)
                                <div class="col-6 col-md-4 col-lg-4 mb-4">
                                    <div data-aos="fade-up" data-aos-delay="{{ 100 + $index * 100 }}">
                                        <div class="service-item"
                                            onclick="window.location.href='{{ route('user::services') }}'">
                                            <div class="service-image">
                                                @if ($portfolio->thumbnail_image_path)
                                                    <img src="{{ Storage::url($portfolio->thumbnail_image_path) }}"
                                                        alt="{{ $portfolio->name }}">
                                                @else
                                                    <img src="{{ asset('assets_user/img/placeholder.png') }}"
                                                        alt="Placeholder">
                                            ...
                                            <div class="service-content">
                                                <h4>{{ strtoupper($portfolio->name) }}</h4>
                                                @if ($portfolio->description)
                                                    <p>{{ Str::limit($portfolio->description, 50) }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="structure-diagram" data-aos="fade-up" data-aos-delay="100">
                            <img src="{{ asset('assets_user/img/organizational_structure.png') }}"
                                alt="Organizational Structure" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="footer-item social-info">
                                ...
                                <div class="social-links">
                                    <div class="social-item">
                                        <img src="{{ asset('assets_user/img/ig_icon.png') }}" alt="Instagram"
                                            class="social-icon">
                                        <span>@mogmainindonesia | Mogmain Indonesia</span>
                                    </div>
                                    <div class="social-item">
                                        <img src="{{ asset('assets_user/img/web_icon.png') }}" alt="Website"
                                            class="social-icon">
                            ...
                            <div class="footer-item contact-info">
                                ...
                                <div class="contact-links">
                                    <div class="contact-item">
                                        <img src="{{ asset('assets_user/img/wa_icon.png') }}" alt="WhatsApp"
                                            class="contact-icon">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.addEventListener('click', (e) => {
                ...
                if (mobileNav && mobileMenuBtn && !mobileNav.contains(e.target) && !mobileMenuBtn.contains(e
                        .target)) {
