                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('event_type') is-invalid @enderror" 
                                ...
                                <option value="running" {{ old('event_type') === 'running' ? 'selected' : '' }}>Running</option>
                                <option value="basketball" {{ old('event_type') === 'basketball' ? 'selected' : '' }}>Basketball</option>
                                <option value="combat_sport" {{ old('event_type') === 'combat_sport' ? 'selected' : '' }}>Combat Sport</option>
                                <option value="mice" {{ old('event_type') === 'mice' ? 'selected' : '' }}>MICE</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('registration_fee') is-invalid @enderror" 
                                   id="registration_fee" name="registration_fee" value="{{ old('registration_fee') }}" min="0" step="0.01">
